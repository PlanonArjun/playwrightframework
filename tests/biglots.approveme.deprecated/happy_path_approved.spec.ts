...
test.describe('biglots approve me', async () => {
     ...
     * @deprecated
     */
    test.skip('happy path approved to results page - apply', { tag: ['@approveme', '@biglots', '@splashpage', '@happy', '@approved'] },async ({browser}) => {
        await expect(async () => {
