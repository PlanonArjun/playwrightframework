...
import HappyPathPending from '../../data/biglots.approveme.deprecated/HappyPathPending';
...
test.describe('pending', async () => {
     ...
     * @deprecated
     */
    test.skip('happy path pending', { tag: ['@approveme', '@biglots', '@splashpage', '@happy', '@pending'] },async ({browser}) => {
        await expect(async () => {
            ...
            await c_startAppPage.happyPathPopulate(happyPathPending.getStartAppData);
            ...
            await g_iDType.happyPathPopulate(happyPathPending.getIdNumber);
            ...
            await j_employerDuration.happyPathPopulate(happyPathPending.getEmployerInfo);
            ...
            await l_bankInfo1Page.happyPathPopulate(happyPathPending.getBankInfo1);

            let m_bankInfo2Page = new M_BankInfo2Page(cPage);
            await m_bankInfo2Page.setIsDirectDeposit(happyPathPending.getBankInfo2);
