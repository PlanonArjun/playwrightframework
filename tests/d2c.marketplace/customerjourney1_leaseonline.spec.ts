...
test.describe('Regression Suite', () => {
    ...
    test.describe('Key Customer Journey 1', () => {
        ...
        test('Lease Online from Grand Parent Retailer page', { tag: ['@regression', '@kcj1'] }, async () => {
            ...
            let expectedRetailerDetailURL = `${testData.urls.marketplace.homeStaging + testData.urls.marketplace.endpoints.shopRetailers}${getProductKeyByName(testData.featuredRetailers.bestBuy)}/`;
