...
export class C_RetailersIndexPage {
    ...
    constructor(page: Page) {
        this.page = page
        this.retailersBreadCrumb = page.locator('li span', { hasText: testData.pageTexts.retailersIndexPage.shopRetailersBreadcrumbText })
        this.cityOrZipInputBox = page.getByPlaceholder(testData.pageTexts.retailersIndexPage.locationInputBoxPlaceholderText)
        this.firstValueInLocationDropdown = page.locator('ul[role="listbox"] li').first()
        this.continueBtnForLocation = page.locator('button', { hasText: testData.pageTexts.retailersIndexPage.continueBtnText })
        this.shopRetailersHeader = page.locator('h1', { hasText: testData.pageTexts.retailersIndexPage.shopRetailersHeaderText })
        this.locationUpdateLink = page.locator('div[class="flex items-center gap-5"] button').first()
        this.locationCancelBtn = page.locator('button', { hasText: testData.pageTexts.retailersIndexPage.cancelBtnText })
        ...
        this.inStoreOptionLeaseToOwnInFilter = page.locator('input[type="radio"][value="In Store"]')
        this.onlineOptionLeaseToOwnInFilter = page.locator('input[type="radio"][value="Online"]')
        this.applyFiltersBtn = page.locator('button', { hasText: testData.pageTexts.retailersIndexPage.applyFiltersBtnText })
        this.clearFiltersBtn = page.locator('button', { hasText: testData.pageTexts.retailersIndexPage.clearFiltersBtnText })
        ...
        this.loadMoreBtn = page.locator('button', { hasText: testData.pageTexts.retailersIndexPage.loadMoreBtnText })
        this.distanceOfRetailersOrOnline = page.locator('span[class="global-text-xxs-medium text-secondary"]')
        this.sortByOption = page.locator('span[class="global-text-sm-medium"]', { hasText: testData.pageTexts.retailersIndexPage.sortByBtnText })
        this.defaultSortBy = page.locator('input[value="nearToFar"]')
        this.applySorting = page.locator('button', { hasText: testData.pageTexts.retailersIndexPage.applySortingBtnText })
        ...
        this.leaseToOwnOptionsHeaderOnModalScreen = page.locator('h2[class="global-text-xs-semi-degular"]', {hasText: testData.pageTexts.retailersIndexPage.leaseToOwnOptionsOnRetailerModalScreenHeaderText})
