...
export class A_BasePage {
    ...
    constructor(page: Page) {
        ...
        this.learnMoreHeader = page.locator('p', { hasText: "Learn More" })
        this.howItWorksLink_LearnMore = page.locator('a span', { hasText: "How it Works" })
        this.contactUsLink_LearnMore = page.locator('a span', { hasText: "Contact Us" })
        this.getTheAppLink_LearnMore = page.locator('a span', { hasText: "Get the App" })
        this.faqsLink_LearnMore = page.locator('a span', { hasText: " FAQs" })
        this.startALeaseBtn_LearnMore = page.locator('button', { hasText: "Start a Lease" })
        ...
        this.forRetailersHeader = page.locator('h2', { hasText: 'For Retailers' })
        this.partnerSignUpLink = page.getByRole('link', { name: 'Partner signup' })
        this.retailerLoginLink = page.getByRole('link', { name: 'Retailer login' })
        this.mediaKitLink = page.getByRole('link', { name: 'Media Kit' })
        this.progCentralLink = page.getByRole('link', { name: 'Prog Central' })
        this.ourBusinessHeader = page.locator('h2', { hasText: 'Our Business' })
        this.aboutUsLink = page.getByRole('link', { name: 'About us' })
        this.investorsLink = page.getByRole('link', { name: 'Investors' })
        this.partnersLink = page.getByRole('link', { name: 'Partners' })
        this.progFoundationLink = page.getByRole('link', { name: 'Prog Foundation' })
        this.careersLink = page.getByRole('link', { name: 'Careers' })
        this.supportHeader = page.locator('h2', { hasText: 'Support' })
        this.howItWorksLink = page.getByRole('link', { name: 'How it works' })
        this.contactUsLink = page.getByRole('link', { name: 'Contact us' })
        this.customerFeedbackLink = page.getByRole('link', { name: 'Customer Feedback' })
        this.blogsLink = page.getByRole('link', { name: 'Blogs' })
        this.faqsLink = page.getByRole('link', { name: 'FAQs' })
        this.appStoreLink = page.getByRole('link', { name: 'Download on App Store' })
        this.playStoreLink = page.getByRole('link', { name: 'Download on Play store' })
        this.fbLink = page.getByRole('link', { name: 'Visit us on Facebook' })
        this.igLink = page.getByRole('link', { name: 'Visit us on Instagram' })
        this.plDeclarationText = page.getByText('Ownership by')
        this.plCopyrightText = page.getByText('all rights reserved')
        this.termsOfUseLink = page.getByRole('link', {name: 'Terms of Use'})
        this.privacyLink = page.getByRole('link', { name: 'Footer link: Privacy' })
        this.trustCentreLink = page.getByRole('link', {name: 'Trust Center'})
        this.dataSubjectRequestsLink = page.getByRole('link', {name: 'Data Subject Requests'})
        this.bipaLink = page.getByRole('link', {name: 'BIPA'})
        this.yourPrivacyChoicesLink = page.getByRole('link', {name: 'Your Privacy Choices'})
