// biglots approve me payment estimator
...
class S_PaymentEstimator {
    ...
    async launchPaymentEstimator() {
         ...
         */
        await this.page.locator('#banner-text-new').getByRole('link', { name: 'Apply Now' }).click();
        await this.page.waitForTimeout(250);
        await this.page.getByRole('button', { name: 'Come Back Later' }).click();
    ...
    async _enterTwoLetterState(state : string) {
        ...
        await this.menuState.press('Tab');
    }
